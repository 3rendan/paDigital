...
?>
<div role="main">
    <h2 style="font-variant:small-caps; text-align: center;">Search results for "<?php echo html_escape($query); ?>" (<?php echo $total_results; ?> items)</h2>
    ...
    <?php echo pagination_links(); ?>
            ...
            <div class="search-result <?php echo strtolower($searchRecordType); ?>">
                        ...
                        <?php elseif ($searchRecordType == 'Exhibit'): ?>
                            ...
                            ?>
                        <?php endif; ?>
                            <h3><a href="<?php echo record_url($record, 'show'); ?>" style="vertical-align:middle;"><?php echo $searchText['title'] ? $searchText['title'] : '[Unknown]'; ?></a></h3>
