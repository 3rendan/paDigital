    ...
    <div class="tombstone">
        <div class="tab-content wrapper">
            ...
            <div class="tab-pane fade" id="Resources">           
                ...
                echo '<a href="http://digital.provath.org/' . $wheaton . '" target="_blank">' . $essay_title . '</a>' . " Wheaton College student essay, 2016." . '<br>';
                ?>
                <br>
                <?php
...
<div class="row" style="padding-top: 20px;">
    ...
    <div class="col-sm-4 col-md-4 pager no-mobile">
        <span class="previous" style="float: right;border: 1px solid #000;border-radius: 4px;padding:5px;margin-right: 20px;"><?php echo link_to_previous_item_show(); ?></span> 
        </div>
    <div class="col-sm-4 col-md-4 pager no-mobile">   
        <span class="next" style="float: left;border: 1px solid #000;border-radius: 4px;padding:5px;"><?php echo link_to_next_item_show(); ?></span>
    </div>
    <div class="col-sm-2 col-md-2">
